//============================================================================
// Name        : AllMediaDeskTest.cpp
// Author      : Mitchel Barton
// Version     :
// Copyright   : Your copyright notice
// Description : AllMediaDesk Application task 1
//============================================================================
...
/*
 *  Represents a token in a Reverse Polish Notation (RPN) expression
 *  i.e. 5 6 4 + *
 *  Class provides interface for handling operators and operands
 */
...
public:
    ...
    /* Allows calculator to consume this token */
...
int main() {
	...
	cout << "*Note acceptable variables are: 0-9, '(', ')', '*', '/', '+', '-'. No spaces please!" << endl;

	cin >> userInput;

	Calculator c;
	cout << c.calculate(userInput) << endl; // prints
	return 0;
}
